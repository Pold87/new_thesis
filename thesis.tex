...
\begin{abstract}
  ...
  techniques. %, such as laser range finders.
...
%in-flight experiments with promising results.
  ...
  processing power to an pre-flight phase to pre-compute
...
\item Can 2D positions be estimated in real-time using a machine
  ...
  environment?
\todo{Why is this important and what follows?}
...
on board of the UAV~\cite{achtelik2011onboard}\todo{write about
  accuracy}, the required processing power is still too complex for
...
\unsure{Not really, only on powerful computers!}The approach works remarkably fast and is robust to different lighting
...
have been put forth\todo{for example}.  They belong to the class of
