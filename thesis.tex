...
control. The \emph{Parrot Bebop Drone} was the prototype for all
flight tests.
...
station. The position estimates were calculated on
...
frequency of approximately 66\,Hz (15\,ms per iteration) on a single
board computer with limited CPU. Shifting processing power to an
offline training step by creating a training set and relying on random
